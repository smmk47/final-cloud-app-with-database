...
# Submit view: create an exam submission record for a course enrollment
...
# Exam result view: check if the learner passed the exam and show the
...
def show_exam_result(request, course_id, submission_id):
    ...
    # For each question, check if the learner got the score and calculate the total score
    total_score = 0
    max_score = 0
