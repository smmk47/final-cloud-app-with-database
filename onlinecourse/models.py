...
# One-To-Many relationship with Course, a grade point for each question
class Question(models.Model):
    ...
    # all correct choices must be selected and no incorrect choice selected
...
# One-To-Many relationship with Question, flags whether the choice is correct
...
class Submission(models.Model):
    ...
    def __str__(self):
        return "Submission " + str(self.id) + " for " + str(self.enrollment.user.username)
